...
void MovePlayer(Player* playerptr, Exit* exitptr)
{
	COORD stagePos = { 50,0 };
	// 이전 위치 저장하기
...
void Player::MovePlayer(Player& playerptr, Pos& playerPos, const Exit& exitptr)
{
	COORD stagePos = { 50,0 };
	// 이전 위치 저장하기
	playerptr.preX = playerptr.playerPos.posX;
	playerptr.preY = playerptr.playerPos.posY;
